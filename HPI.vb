...
Public Class HPI
    ...
    Private Sub HPI_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

        Select Case HPIDisplayMode
    ...
    Private Sub Save_btn_Click(sender As System.Object, e As System.EventArgs) Handles Save_btn.Click
        ...
        Try
            ...
            SQLCon1.Open()
            SQLCmd1.CommandText = "sp_insert_MTM_1" ' Stored Procedure to Call
            ...
            SQLCmd1.Parameters.Add("vcmx1", SqlDbType.VarChar).Value = HPI_txt.Text
